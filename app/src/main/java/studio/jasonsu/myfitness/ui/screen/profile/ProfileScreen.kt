...
import studio.jasonsu.myfitness.ui.icon.NavigationIndicatorIcon
...
fun ProfileScreen(
    ...
    val height by viewModel.heightInCm.collectAsStateWithLifecycle()
    val weight by viewModel.weightInKg.collectAsStateWithLifecycle()
    val editDialogConfig by viewModel.editDialogConfig.collectAsStateWithLifecycle()
