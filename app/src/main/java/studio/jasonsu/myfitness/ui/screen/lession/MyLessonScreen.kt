...
fun MyLessonScreen(
    ...
    val screenMode by viewModel.screenMode.collectAsStateWithLifecycle(initMode)
    val hasSelectedLesson by viewModel.hasLessonsSelected.collectAsStateWithLifecycle()
    val isEditMode = (screenMode == LessonScreenMode.Edit)
    val hasLessons = lessons.isNotEmpty()
    val needAddProfile by viewModel.needAddProfile.collectAsStateWithLifecycle(false)
